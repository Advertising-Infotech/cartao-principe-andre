...
const socialLinks = [
  { href: 'https://www.youtube.com/@Desnecessaurospodcast', icon: <Youtube size={20} /> },
  { href: 'https://www.instagram.com/tiranossaurusrex/', icon: <Instagram size={20} /> },
  { href: 'https://x.com/Tiranossaurus', icon: <Twitter size={20} /> },
  { href: 'https://www.facebook.com/t.rex.hacker', icon: <Facebook size={20} /> },
  { href: 'https://t.me/+5562991599031', icon: <Send size={20} /> },
  { href: 'https://www.reddit.com/user/Tiranossaurus_Rex/', icon: <RedditIcon size={20} /> },
  { href: 'https://discord.com/', icon: <DiscordIcon size={20} />, title: 'Discord: poisonsource' },
  { href: 'https://www.tiktok.com/@tiranossaurus_rex', icon: <TikTokIcon size={20} /> },
];
  ...
  return (
    <div className="flex flex-col items-center text-center mb-2">
      ...
      <div className="relative mb-4 group">
        <div className="absolute inset-0 rounded-3xl bg-[#D4AF37] blur opacity-40 group-hover:opacity-60 transition-opacity duration-500" />
        <img
      ...
      <h1 className="text-[2.1rem] font-bold tracking-tight mb-3 drop-shadow-lg leading-none animate-blink-name">
        <span className="italic">{nameParts[0]}</span> {nameParts.slice(1).join(' ')}
      </h1>

      <h2 className="text-[#D4AF37] text-sm font-semibold uppercase tracking-widest mb-1 w-full">
        {t('role')}
      </h2>
      ...
      <div className="flex gap-6 mb-2">
        {socialLinks.map((link, index) => (
          <a
            ...
            title={link.title}
            className="text-gray-400 hover:text-[#D4AF37] transition-colors duration-300 hover:scale-110 transform"
          >
            {link.icon}
          </a>
        ))}
